...
- **AWS CDK CLI (v2.x) - Global installation required**
...
**⚠️ Important:** This project requires a **global CDK CLI installation**. Local CDK CLI (`npx cdk`) has compatibility issues and may not generate `cdk.out` properly.
...
- ✅ **Environment variables** set (`export CDK_DEFAULT_REGION=us-east-1`)
